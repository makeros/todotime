...
var $author$project$Tasks$init = function (maybePreferencesModel) {
...
var $author$project$Tasks$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Tasks$update = F2(
	function (msg, model) {
...
var $author$project$Tasks$view = function (model) {
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Hello Tasks')
					])),
				A2(
...
var $author$project$Tasks$main = $elm$browser$Browser$document(
	{init: $author$project$Tasks$init, subscriptions: $author$project$Tasks$subscriptions, update: $author$project$Tasks$update, view: $author$project$Tasks$view});
_Platform_export({'Tasks':{'init':$author$project$Tasks$main(
